...
(function () {
  'use strict';
  angular.module('yh.featureToggle', ['semver']).config(initFeatures).config(overrideUIRouterStateFn).provider('featureToggle', featureToggle).directive('showIfFeature', showIfFeature).directive('hideIfFeature', hideIfFeature);
...
(function () {
  'use strict';
  angular.module('semver', []).provider('semver', semver);
