...
# Script for updating the bower repos from current local build.
...
function prepare {
  ...
  do
    ...
    git clone git@github.com:Mixpo/bower-$repo.git $TMP_DIR/bower-$repo
  done
  ...
  do
    ...
    # we don't have a package.json in our bower repos
